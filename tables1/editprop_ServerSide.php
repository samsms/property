...
//$aColumns = array($propid ,$propname,$plotno,$proptype,$address, $category,$owner,$mohalla,$occupants,$numfloors,$area,$title);
	$aColumns = array('propertyid' ,'property_name','plotno','property_type','address', 'category','owner','mohalla','water_rate','numfloors','area','detailslink'); //Change Column Headings
