...
<tr>
    <td></td>
    <td><input type="submit" id="add-payment-reason"  class="text ui-widget-content ui-corner-aEll" value="SAVE" style="width:250px;font-weight:bold;"/></td></tr>  
</tr>
</table>
</center>
</form>
...
<fieldset>
<table>  
<tr><td><label for="pname"> Select&nbsp;</label></td>
<script>
 ...
 <tr style="display:none" id="propname"><td><label for="pname">Property Name. &nbsp;</label></td>
...
</div><!--tenant statement's arrears and prepayments-->
...
<tr><td><label>FROM :</label>
        </td><td>
            <input id="fromdateperformance" class="datepicker" name="fromdate" placeholder="From Date" readonly style="width:200px; height:20px; border:1px solid green "/><td></tr>
   <tr><td><label> To:</label>
        </td><td>
            <input id="todateperformance" placeholder="To Date" class="datepicker" name="todate" readonly style="width:200px; height:20px; border:1px solid green "/></td></tr>
    <tr><td><br><br></td></tr>
<tr><td></td><td><input type="submit" id="btnfetchplotperformance"  class="text ui-widget-content ui-corner-aEll" value="VIEW REPORT" style="width:150px;font-weight:bold;"/></td></tr>
</table></center>
</fieldset>
</form>
</div>
...
<table>  
    ...
    <td colspan="3" style="padding: 10px;" >
     <input type="range" min="0" max="100" value="0" class="slider" id="myRange" >
        </td><td style=" padding-left: 50px;"><span id="demo"></span>%</td>
    </tr>
      <tr>
         <td colspan="4" style="padding: 10px;" >
    ...
    <td colspan="3" style="padding: 10px;" >
     <input type="range" min="0" max="100" value="0" class="slider" id="myRangeto" >
        </td><td style=" padding-left: 50px;"><span id="demoto"></span>%</td>
    </tr>
    <tr>
...
<tr><td><label>FROM :</label>
            ...
            <input id="fromdatefilterbypercentage" class="datepicker" name="fromdate" placeholder="From Date" readonly style="width:200px; height:20px; border:1px solid green "/><td></tr>
   <tr><td><label> To:</label>
        </td><td>
            <input id="todatefilterbypercentage" placeholder="To Date" class="datepicker" name="todate" readonly style="width:200px; height:20px; border:1px solid green "/></td></tr>
    <tr><td><br><br></td></tr>
<tr><td></td><td><input type="submit" id="btnfilterbypercentage"  class="text ui-widget-content ui-corner-aEll" value="VIEW REPORT" style="width:150px;font-weight:bold;"/></td></tr>
