...
//$invoices=getinvoicelistChargeables($startdate,$enddate,$_REQUEST['accid'],$_REQUEST['accname'],$_REQUEST['propid'],$_SESSION['username']);
    ...
    <table class="treport">
        <thead>
        <tr>
            <td><img src="../images/cursors/anjuman.png" style="height:50px;width:70px;"></td>
            <td colspan="7" style="background-color:beige">
                <h3>
                    <center>BANK STATEMENT FOR <i><?php echo $accountdetails[0]['acname']; ?></i>
                        &nbsp;BETWEEN&nbsp;<?php echo date('F j,Y', strtotime($fromdate)) . '&nbsp;AND &nbsp;' . date('F j,Y', strtotime($todate)) ?>
                    </center>
                </h3>
            </td>
        </tr>
    ...
    <table class="treport">
        ...
        <tr>
            ...
            <td colspan="9" style="background-color:beige">
                <h3>
                    <center>DEPOSIT REFUND STATEMENT <i><?php echo $accountdetails[0]['acname']; ?></i> &nbsp;BETWEEN&nbsp;<?php echo date('F j,Y', strtotime($startdate)) . '&nbsp;AND &nbsp;' . date('F j,Y', strtotime($enddate)) ?>
                    </center>
                </h3>
            </td>
        </tr>
...
<?php } elseif ($reportpost == 'fetcharrearsprepayments') {
    ...
    <table class="treport">
        ...
        <tr>
            ...
            <td colspan="4" style="background-color:beige">
                <h3>
                    <center>COMMISSIONS LIST
                        &nbsp;BETWEEN&nbsp;<?php echo date('F j,Y', strtotime($startdate)) . '&nbsp;AND &nbsp;' . date('F j,Y', strtotime($enddate)) ?></center>
                </h3>
            </td>
        </tr>
        <tr>
...
<?php } elseif ($reportpost == 'accounttransactions') {
    ...
    <table class="treport exportlist">
        ...
        <tr>
            ...
            <td colspan="7" style="background-color:beige">
                <h3>
                    <center>INTERNAL BANK TRANSACTIONS
                        &nbsp;BETWEEN&nbsp;<?php echo date('F j,Y', strtotime($startdate)) . '&nbsp;AND &nbsp;' . date('F j,Y', strtotime($enddate)) ?></center>
                </h3>
            </td>
        </tr>
