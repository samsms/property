...
//                }
        ...
        $receiptno = $_REQUEST['receiptno']; // assuming the receipt numbers are passed in as a comma-separated string

        $receipt_array = explode(',', $receiptno);
        ...
        // echo printreceipt($receipt_array[0], $username);
        // echo printreceipt($receipt_array[1], $username);
        
       
        foreach ($receipt_array as $receipt) {
            echo printreceipt($receipt, $username);
        }
