...
elseif($reportpost==='fetchaccountstatement'){
   ...
   <table class="treport" ><thead>
           <tr><td><img src="../images/cursors/logo1.png" style="height:50px;width:70px;"></td><td colspan="7" style="background-color:beige"><h3><center>BANK STATEMENT FOR <i><?php echo $accountdetails[0]['acname']; ?></i> &nbsp;BETWEEN&nbsp;<?php echo date('F j,Y',  strtotime($fromdate)) . '&nbsp;AND &nbsp;' .date('F j,Y',  strtotime($todate)) ?></center></h3></td></tr>
<tr>
...
elseif($reportpost==='depositrefundlist'){ 
   ...
   $deposits=getDepositRefundList($startdate, $enddate, $propid);
    ?>
  <table class="treport" ><thead>
           <tr><td><img src="../images/cursors/logo1.png" style="height:50px;width:70px;"></td><td colspan="9" style="background-color:beige"><h3><center>DEPOSIT REFUND STATEMENT  <i><?php echo $accountdetails[0]['acname']; ?></i> &nbsp;BETWEEN&nbsp;<?php echo date('F j,Y',  strtotime($startdate)) . '&nbsp;AND &nbsp;' .date('F j,Y',  strtotime($enddate)) ?></center></h3></td></tr>
<tr>
<th><center><u> No</u></center></th>
   <th><center><u>Date</u></center></th>
...
<a href="#" class="export">Export Table data into Excel</a>
 <?php }
 elseif($reportpost=='fetchbypercentage'){
...
elseif($reportpost=='commissionlist'){
    $startdate=htmlspecialchars($_REQUEST['startdate']);
     ...
     ?>
<table class="treport" ><thead>
        <tr><td><img src="../images/cursors/logo1.png" style="height:50px;width:70px;"></td><td colspan="4" style="background-color:beige"><h3><center>COMMISSIONS LIST &nbsp;BETWEEN&nbsp;<?php echo date('F j,Y',  strtotime($startdate)) . '&nbsp;AND &nbsp;' .date('F j,Y',  strtotime($enddate)) ?></center></h3></td></tr>
<tr>
<th><center><u> No</u></center></th>
<th><center><u>Property</u></center></th>
...
<table class="treport exportlist" ><thead>
        <tr><td><img src="../images/cursors/logo1.png" style="height:50px;width:70px;"></td><td colspan="7" style="background-color:beige"><h3><center>VACANCY REPORT</center></h3></td></tr>
<tr>
<th><center><u> No</u></center></th>
...
elseif($reportpost=='accounttransactions'){
  ...
  $transactions=getBankTransactions($startdate, $enddate,$account);
    ?>
<table class="treport exportlist" ><thead>
        <tr><td><img src="../images/cursors/logo1.png" style="height:50px;width:70px;"></td><td colspan="7" style="background-color:beige"><h3><center>INTERNAL BANK TRANSACTIONS  &nbsp;BETWEEN&nbsp;<?php echo date('F j,Y',  strtotime($startdate)) . '&nbsp;AND &nbsp;' .date('F j,Y',  strtotime($enddate)) ?></center></h3></td></tr>
<tr>
<th><center><u> No</u></center></th>
